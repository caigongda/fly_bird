...
game = new Phaser.Game(288, 505, Phaser.CANVAS, "game");
...
game.States.preload = function() {
    this.preload = function() {
        ...
        game.load.image('btn', 'assets/start.png');
...
game.States.menu = function() {
    this.create = function() {
        ...
        var ground = game.add.tileSprite(0, game.height-152, game.width, 152, 'ground');
        bg.autoScroll(-10 ,0);
...
game.States.play = function() {
    this.create = function() {
        ...
        this.ground = game.add.tileSprite(0, game.height-152, game.width, 152, 'ground');
    ...
    this.generatePipes = function() {
        ...
        var position = 50 + Math.floor((505 - 152 - difficulty - gap) * Math.random());
